...
function DataBooks({ books, resultSearch }) {
  ...
  return (
    <>
      <div className="flex">
        <div className="grid grid-cols-1 gap-4  sm:grid-cols-2 md:gap-6 mx-auto static">
          <ToastContainer
            position="top-right"
            autoClose={3000}
          ...
          {/* Same as */}
          <ToastContainer />
          {resultSearch === "bad-request" ? (
            <div className="md:absolute md:left-[400px] md:bottom-20">
              <h1 className="text-7xl text-gray-300 font-bold">
                404 Book not found
              </h1>
            </div>
                      ...
                      <Menu>
                        <Menu.Button>
                          <div className="p-3 flex rounded-lg mb-2 border border-indigo-500 ui-open:hidden">
                            <span className="m-auto text-indigo-500">
                              Options
                            </span>
                          </div>
                        </Menu.Button>
